...
const array = ['Azaru','broken','dybala','Hi','Kochi','life','love','power','Rahza','Shahmi','uyir','kozhi','No','Ok','chunk','Bgm','India','poda','bike','patti','endi','Hacker','Hero','song','Hy','Hlo','waiting','Hii','ganja','feel','bot','Nasheek','Good night','girl']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
